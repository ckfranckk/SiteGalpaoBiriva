  ...
  return (
    <main className="biriva-site">
      ...
      <section id="servicos" className="services section-dark"><div className="section-heading center"><div className="section-kicker">O que fazemos</div><h2>Um galpão para <i>viver</i></h2><p>Da primeira conversa ao último acorde, criamos o cenário para a sua celebração.</p></div><div className="service-grid">
        ...
        <article className="service-card"><img src={images.fire} alt="Buffet e churrasco" /><div className="service-body"><span>02 · Recepção</span><h3>Buffet & Acolhimento</h3><p>Estrutura preparada para receber seus convidados com conforto e um buffet tradicional que combina com a experiência.</p><button onClick={() => scrollTo("contato")}>Consultar detalhes ↗</button></div></article>
      ...
      <section id="galeria" className="gallery section-light"><div className="section-heading"><div className="section-kicker">Galeria de experiências</div><h2>Feito para <i>marcar</i></h2></div><div className="gallery-grid"><figure className="gallery-tall"><img src={images.nature} alt="Natureza ao redor do galpão" /><figcaption>Natureza & acolhimento</figcaption></figure><figure><img src={images.pool} alt="Área externa" /><figcaption>Lazer externo</figcaption></figure><figure><img src={images.fire} alt="Buffet e fogo de chão" /><figcaption>Sabores</figcaption></figure><figure className="gallery-wide"><img src={images.stage} alt="Palco e música" /><figcaption>Palco de emoções</figcaption></figure><figure><img src={images.horse} alt="Elemento campeiro" /><figcaption>Alma campeira</figcaption></figure></div></section>
